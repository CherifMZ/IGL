...
class NavAdmin extends Component{
    constructor(props) {
        ...
        this.state = { //state is by default an object
           adminpgs: [
              { imgsrc: '/img/student.png', text: 'Gestion des étudiants',drl:[
                    {link: "/etudiant/add", imgsrc: '/img/form.png', text: 'Inscription'}
                ]
              },
              { imgsrc: '/img/teacher.png', text: 'Gestion des enseig...',drl:[
                    {link: "/enseignant/add", imgsrc: '/img/form.png', text: 'Inscription'}
                ]
               },
